...
useEffect(() => {
  ...
  return (
      <div>
        ...
        {floorHovered && <p className={css.text}><span className={css.number}>{floorHovered}</span>ème etage</p> }
        {!floorHovered && <p className={css.text}>Selectionnez un étage</p> }
</div>
)
}
